...
class Faculty:
    ...
    professor_type: Optional[str] = None
...
class Room:
    ...
    room_type: Optional[str] = "SMART"  # 'PROJECTOR', 'SMART', 'LAB'
    availability: Optional[str] = None
...
class Lab:
    ...
    lab_incharge_id: Optional[str] = None
...
class Course:
    ...
    theory_hours: int = 3
    lab_hours: int = 0
    course_type: Optional[str] = "CORE"  # 'CORE', 'ELECTIVE'
    required_laboratory: Optional[str] = None
