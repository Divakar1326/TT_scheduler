...
class ModelMapper:
    ...
    def to_faculty(data: Dict[str, Any]) -> Faculty:
        return Faculty(
            ...
            professor_type=data.get("professor_type"),
    ...
    def to_lab(data: Dict[str, Any]) -> Lab:
        return Lab(
            ...
            lab_incharge_id=data.get("lab_incharge_id"),
    ...
    def to_course(data: Dict[str, Any]) -> Course:
        return Course(
            ...
            required_laboratory=data.get("required_laboratory"),
    ...
    def to_rule(data: Dict[str, Any]) -> Rule:
        return Rule(
            ...
            description=data.get("original_text") or data.get("description"),
