...
from app.constraints.hard_constraints import check_faculty_clash, check_room_clash
from app.constraints.soft_constraints import score_morning_lab_preference, score_compact_timetable
